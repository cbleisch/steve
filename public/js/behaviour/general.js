    ...
    return {
        ...
        activate: function(parent) {
            ...
            if(config.bootstrapSwitch){
                ...
                parent.find('.switch').each(function (index, element) {
                    $sw = $(element);
                    var onColor = $sw.attr('data-on-color');
                    var offColor = $sw.attr('data-off-color');
                    if($.trim(onColor) != "" && $.trim(offColor) != "") {
                        $div = $sw.parent().parent()
                        $div.addClass('bootstrap-switch-onclr-' + onColor);
                        $div.addClass('bootstrap-switch-offclr-' + offColor);
                    }
                });
            }
            ...
            if(config.select2){
                ...
                parent.find(".select2-center").select2({
                    width: '100%',
                    templateSelection: function(item) {
                        return $('<div class="text-center" style="line-height: 32px">' + item.text + '</div>');
                    },
                    templateResult: function(item) {
                        return $('<div class="text-center">' + item.text + '</div>');
                    },
                    minimumResultsForSearch: 6
                });

                parent.find(".select2-left").select2({
                    width: '100%',
                    templateSelection: function(item) {
                        return $('<div class="text-left" style="line-height: 32px">' + item.text + '</div>');
                    },
                    templateResult: function(item) {
                        return $('<div class="text-left">' + item.text + '</div>');
                    },
                    minimumResultsForSearch: 6
                });

                parent.find(".select2-right").select2({
                    width: '100%',
                    templateSelection: function(item) {
                        return $('<div class="text-right" style="line-height: 32px">' + item.text + '</div>');
                    },
                    templateResult: function(item) {
