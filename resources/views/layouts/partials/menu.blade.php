<ul class="cl-vnavigation">
	<li>
		...
		<li class="{{ Request::url() == URL::route('proposal.index.get') ? 'active' : '' }}"><a href="{{ URL::route('proposal.index.get') }}"><i class="fa fa-file-text"></i><span>Proposals</span></a></li>
		<li class="{{ Request::url() == URL::route('agreementLength.index.get') ? 'active' : '' }}"><a href="{{ URL::route('agreementLength.index.get') }}"><i class="fa fa-calendar"></i><span>Agreement Lengths</span></a></li>
		<li class="{{ Request::url() == URL::route('package.index.get') ? 'active' : '' }}"><a href="{{ URL::route('package.index.get') }}"><i class="fa fa-box"></i><span>Product Packages</span></a></li>
