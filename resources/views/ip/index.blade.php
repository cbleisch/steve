...
@section('breadcrumbs')
<li class="active">Static IP Products</li>
@stop

@section('page-header')
    <a class="pull-right btn btn-success" href="{{ URL::route('ip.create.get') }}">Add Static IP Product</a>
<h3>
    Static IP Products
</h3>
@stop
                    ...
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td class="text-right" style="width: 15%">
                                <a href="{{ URL::route('ip.create.get', [$product->id]) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                <form action="{{ URL::route('ip.destroy.post', [$product->id]) }}" method="POST" class="form-inline">
