...
@section('breadcrumbs')
<li><a href="{{ URL::route('ip.index.get') }}">Static IP Products</a></li>
<li class="active">{{ $product->id ? 'Modify' : 'Create'  }}</li>
@stop

@section('page-header')
<h3>
    {{ $product->id ? 'Modify' : 'Create'  }} Static IP Product: {{ $product->name }}
</h3>
@stop
...
@section('content')
	<div class="block-flat">
		<div class="content" style="margin-top:-20px">
            <form action="{{ URL::route('ip.store', [$product->id]) }}" method="POST">
